...
const listItemData = [
  ...
  { id: "translate", text: "다국어 실시간 번역", icon: <GTranslateIcon />, shortName: '번역', disabled: true },
  // 다른 아이템들...
] as ListItem[];
        ...
        <>
          ...
          <List dense sx={{ border: '1px solid rgba(0, 0, 0, 0.12)', borderRadius: '4px' }}>
            <ListItem>
              ...
              <ListItemText primary="이 기능 사용하기" />
            </ListItem>
            <ListItem>
              <ListItemIcon>
                <HorizontalRule />
              </ListItemIcon>
              <ListItemText primary="서버 설정에 따라 자동으로 적용" />
            </ListItem>
            <ListItem>
              <ListItemIcon>
                <DoNotDisturb color='error' />
              </ListItemIcon>
              <ListItemText primary="이 기능 사용하지 않기" />
            </ListItem>
          </List>
        </>
      }
