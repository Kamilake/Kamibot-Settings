      ...
      <Box sx={{ my: 1 }}>
        ...
        <Box>
          ...
          {/* <Typography variant="body1" gutterBottom component="div">
            ...
            <br />
            그리고 좋은 소식이 있어요! 어떻게든 보이스를 살리기 위해 저희는 카미봇에 여러 가지 도전 과제를 추가할 예정이에요. <b>멤버십을 가진 사용자나 도전 과제를 달성한 사용자는 추가적인 보이스 모델을 사용할 수 있게 될 거예요.</b> 이렇게 하면 {memberName}이 카미봇을 더욱 즐겁게 사용하면서 다양한 숨겨진 기능들을 경험할 수 있죠. 이 기능에 대한 자세한 내용은 곧 공개될 예정이니, 기대해주세요!<br />
            <br />
